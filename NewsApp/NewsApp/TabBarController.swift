...
final class TabBarController: UITabBarController {
    ...
    private func setUpViewControllers() {
        viewControllers = [
            ...
            setUpNavigationController(rootViewController: BusinessViewController(viewModel: BussinesViewModel()), title: "Business", image: UIImage(systemName: "briefcase") ?? UIImage.add),
